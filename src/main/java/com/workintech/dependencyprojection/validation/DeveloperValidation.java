package com.workintech.dependencyprojection.validation;
...
public class DeveloperValidation {
     ...
     public static boolean isDeveloperValid(Developer developer){
           return  isIdValid(developer.getId()) && developer.getName()!=null
         && !developer.getName().isEmpty()&& developer.getSalary()>25000;
     }
}
